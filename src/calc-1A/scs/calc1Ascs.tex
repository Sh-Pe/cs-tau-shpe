...
\title{\en{Shit Cheat Sheet {\normalsize(\textbf{v}\textit{1})} $\sim$ Calculus 1A $\sim$ TAU}}
\date{\en{\textit{3.10.2025} $\to$ \textit{25.1.2026}}}
\begin{document}
	\textit{הערה חשובה: }עבור סטודנטים שלא למדו מהי נקודת התכנסות, אפשר להתייחס אליה כנקודה בה הגבול מוגדר (לדוגמה, לא בקצה קטע סגור). 
	...
	\begin{multicols}{2}
		...
		\end{Theorem}
		\begin{Theorem}[א''ש ברנולי]
			\hfil $\forall x > -1 .\,\forall n \in \N \co (1 + x)^{n} \ge 1 + nx$
		\end{Theorem}
		
		\begin{Theorem}[א''ש המשולש]
			\[ \sof{\sof x - \sof y} \le \sof{x + y} \le \sof x + \sof y \]
		\end{Theorem}
		\cola{תוצאה מא''ש המשולש
		...
		\defi{אם $a_n$ חסומה מלעיל, נסמן:
			
			 $\sup a_n := \sup_{n \in \N} a_n := \sup \ang$}
		\defi{אם $a_n$ חסומה מלרע, נסמן:
			
			 $\inf a_n := \inf_{n \in \N} a_n := \inf \ang$}
		...
		\theo{תהאנה $\an, \bc$ סדרות. יהיו $\ml, m \in \R$ ממשיים. נניח כי $\limasi = \ml \land \limbsi = m$. אז:
			\begin{enumerate}
				...
				\item \hfil $\displaystyle \climsi a_n b_n = \ml \cdot m$
				\item \hfil $\displaystyle m \neq 0 \implies \quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad(\exists N \in \N.\, \forall n \ge N\co b_n \neq 0) \land \cl{\limsi \frac{a_n}{b_n} = \frac{\ml}{m}}$
		\end{enumerate}}
		...
		\begin{Theorem}
			...
			אז $\limsi c_n = \ml$
		\end{Theorem}
		\theo{תהנא $\an, \bn$ סדרות. יהיו $\ml, m \in \R$. נניח:
			\begin{enumerate}[(1)]
		...
		\begin{Theorem}[סגירות סדרתית של קבוצת הגבולות החלקיים]
			תהא $\an$ סדרה, חסומה. תהא $\bn$ סדרה, המקיימת:
				\begin{enumerate}
		...
		\noti{בהינתן $F \co \N \to \R \cup \{\pm \infty\}$ כלשהי:
			\begin{gather*}
				\inf_n F(n) = \inf \{F(n) \mid n \in \N\} \\ \sup_n F(n) = \sup \{F(n) \mid n \in \N\}
			\end{gather*}}
		
		\subsection{נושאים מתקדמים בסדרות}
		...
		\theo{אם $\limsi a_n \to L$ אז $\limsi \sof{a_n}  \to L$. }
		...
		\begin{Theorem}[מבחני התכנסות לסדרות]\,
			\begin{itemize}
				\item \textbf{מבחן המנה הגבולי: }תהא $a_n$ חיובית ונניח $\limsi \frac{a_n}{a_{n + 1}} = \ml$. אם $\ml < 1$ אז $a_n \to 0$, ואם $\ml > 1$ אז $a_n \to \inft$. 
				\item \textbf{מבחן המנה המוכלל: }בהינתן $a_n$ חיובית, אם קיים $L \in \R$ כך שהמ''מ $a_{n + 1} < La_n$ אז $\limsi a_n = \inft$. 
				\item \textbf{מבחן השורש: }תהא $\an$ סדרה חיובית. נניח $\limsi \sqrt[n]{a_n} = \ml$. אם $\ml < 1$ אז $a_n \to 0$, ואם $L > 1$ אז $a_n \to \inft$. 
				\item \textbf{הלמה של שטולץ: }תהאנה $\an, \bn$ סדרות ונניח ש־$\bn$ מונוטונית ממש ו־$b_n \to +\infty$. אם קיים וסופי $\limsi \frac{a_{n + 1} - a_n}{b_{n + 1} - b_n}$ אז קיים וסופי $\limsi \frac{a_n}{b_n}$ וגבולותיהם שווים (לופיטל 2 בדיד).
			\end{itemize}
		\end{Theorem}
		\theo{לכל $a, b > 0$, אם $a \neq 1$ אז קיים ויחיד $x \in \R$ כך ש־$a^{x} = b$. }
		\section{טורים}
		\subsection{הגדרות בסיסיות}
		\cola{הפונקציה $\log_a(x)$ מוגדרת היטב. }
		...
		\begin{Theorem}[קריטריון אבל להתכנסות]
			תהאנה $\an, \bn$ סדרות. נניח:
			\begin{enumerate}
				\item $\bn$ מונוטונית וחסומה (אבל לא בהכרח מתכנסת ל־$0$).
		...
		\begin{Theorem}[קריטריון דיריכלה להתכנסות]
			תהאנה $\an, \bn$ סדרות. נניח:
			\begin{enumerate}
				\item $\bn$ מונוטונית וגבולה $0$.
				\item סדרת הסכומים החלקיים המתאימה ל־$\an$ חסומה (אבל לא בהכרח מתכנסת).
			\end{enumerate}
			אז $\sumninf a_n b_n$ מתכנס.
		\end{Theorem}
		\begin{Theorem}[התכנסות טור גיאומטרי]
			(התכנסות אמ''מ $\sof{r} < 1$): 
			\[ \sum_{k = 0}^{n}a_0r^{k} = a_0\cdot\frac{r^{n} - 1}{r - 1} \toinf \frac{a_0}{1 - r} \]
		\end{Theorem}
		\theo{
		\begin{align*}
			\sumnko k = \binom{n}{2} && \sumnko k^{2} = \frac{n(n + 1)(2n + 1)}{6}
		\end{align*}}
	
		\subsection{אסוצאטיביות וקומטטיביות ש לטורים}
		...
		\subsection{הטופולוגיה ב־$\R$}
		תת־הפרק להלן נלמד לעיתים באודיסאה, אך רוב המרצים ידלגו עליו. 
		...
		\theo{$A$ סגורה אמ''מ היא סגורה סדרתית. }
		...
		\theo{$A$ קומפקטית אמ''מ לכל כיסוי שלה יש תת־כיסוי סופי. }
		...
		\end{enumerate}}
		\theo{תהאנה $f \co A \subseteq \R\to B \subseteq \R, \ g \co B \to \R$. תהא \lxo. יהיו $y_0, \ml \in \R$. 	נניח:
			\begin{enumerate}
				\item $\limxo f(x) = y_0$
		...
		\subsection{גבולות חלקיים}
		\defi{נגדיר את הסימון הבא לסיכום הזה בלבד (הוא לא מקובל). תהא $A \subseteq \R$ ותהא $x_0 \in \R$ נקודת הצטברות של $A$. נסמן $A_{x_0^{+}} := = A \cap (x_0, +\infty)$. נגדיר את $A_{x_0^{-}} :=  = A \cap (-\infty, x_0)$.}
		\cola{מהמשפט הקודם, אם $x_0$ נקודת הצטברות של $A$, אז $x_0$ נקודת הצטברות של $A_{x_0^{+}}$ וכן של $A_{x_0^{-}}$. }
		...
		\theo{\dequad \dequad \dequad \dequad \hfil $\disty \lim_{x \to 0}\frac{\sinx}{x} = 1$
			
		\hfil $\disty \limz \frac{\ln(1 + x)}{x} = 1$
		
		\hfil $\disty \frac{e^{x} - 1}{x} = 1$}
		...
		\defi{$f$ \textit{רציפה במידה שווה} (\textit{רבמ''ש} או \textit{רציפה במ''ש}) אם לכל $\eg > 0$ קיים $\dg > 0$ כך שלכל $x, y \in A$ אם $\sof{x - y} < \dg$ אז $\sof{f(x) - f(y)} < \eg$. }
		...
		\theo{תהאנה $f, g \co A \to \R$. נניח כי $f$ רציפה במידה שווה ב־$A$ וגם $g$ רציפה במידה שווה ב־$A$. אז:
			\begin{itemize}
				\item $f\pm g$ רציפה במידה שווה ב־$A$.
		...
		\theo{יהי $a, b \in \R$ ונניח $a < b$. תהא $f \co (a, b) \to \R$ רציפה. אז $f$ רציפה במידה שווה ב־$(a, b)$ אמ''מ קיימים ל־$f$ הגבולות ב־$a$ וב־$b$ והם סופיים. }
		...
		\noti{בהנחה שהגבול לעיל ב־$x_0$ של הפונקציה $f$ קיים, נסמן $\frac{\dd f}{\dx}(x_0)$ או $f'(x_0)$. }
		...
		\theo{פונקציה היא דיפרנציאבילית ב־$x_0$ אמ''מ היא גזירה ב־$x_0$ (ב־$\R$). }
		...
		\defi{\textit{נגזרת/גזירה מימין} מוגדרת באופן דומה. }
		\noti{נסמן את הגזירה משמאל ב־$f_-'(x_0)$ ומימין $f_+'(x_0)$. }	
		\theo{יהיו $f, g \co I \to \R$ ותהי $x_0 \in I$ בפנים הקטע. נניח ש־$f, g$ גזירות ב־$x_0$. אז:
			\begin{itemize}
				\item לכל $\ag, \bg \in \R$ מתקיים $\ag f + \bg g$ גזירה ב־$x_0$ וכן $(\ag f + \bg g)' = \ag f'(x_0) + \bg g'(x_0)$ (הנגזרת לינארית)
		...
		\theo{תהא $f \co I \to J$ פונקציה גזירה חח''ע ועל, כאשר $I, J$ קטעים פתוחים (אפשר להכליל לקטעים אחרים). אז $f\op$ גזירה בכל נקודה ב־$J$ ומתקיים:
			\[ \forall y \in J \co (f\op(y))' = \frac{1}{f'(f\op(y))} \]
		}
		...
		\begin{Collary}[שארית בצורת פאנו]
			תהא $f \co I \to \R$ ותהא $x_0 \in I$. יהי $n \in \N$ ונניח ש־$f$ גזירה $n$ פעמים ב־$x_0$. אז קיימת $\wg \co I \to \R$ המקיימת $\wg(x_0) = 0$ ו־$\wg$ רציפה בנקודה $x_0$, וגם:
			\[ R_n(x) = \wg(x)(x - x_0)^{n} \]
		\end{Collary}
		...
		\begin{Theorem}[שארית לפי לגראנג']
...
%		\end{align*}}
		\theo{\begin{align*}
			\sinx &= \sum_{n = 0}^{\inft}(-1)^{n}\frac{x^{2n + 1}}{(2n + 1)!} \\
			\cosx &= \sum_{n = 0}^{\inft}(-1)^{n}\frac{x^{2n}}{(2n)!} \\
			e^{x} &= \sum_{n = 0}^{\inft}\frac{x^{n}}{n!} \\
			e^{-x} &= \sum_{n = 0}^{\inft}\frac{(-1)^{n}x^{n}}{n!} \\
			\dequad\dequad\dequad\dequad\!\forall x \in (-1, 1] \co \ln(1 + x) &= \frac{(-1)^{n - 1}x^{n}}{n}
		\end{align*}}
	\end{multicols}
