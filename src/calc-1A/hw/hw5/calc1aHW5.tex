...
\newcommand\midmath[1] {\hfil $\displaystyle #1 $}
\newcommand\ank   {{a_{n_k}}}
\newcommand\anj   {{a_{n_j}}}
\newcommand\bnk   {{b_{n_k}}}
\let\disty\displaystyle
...
\begin{document}
	...
	\begin{enumerate}[(A)]
		...
		\end{proof}
		\item מצאתי שני תנאים, אני לא סגור מי מהם אתם רוצים אז אוכיח את שניהם. אף אחד מהתנאים לא פועל במובן הרחב, בשביל זה צריך לפרק למקרים. 
		\begin{align}
			&L = \liminf a_n = \inf \ps (\an) \\
			\iff &(\forall \eg > 0.\, \exists N \in \N.\, \forall n \ge N \co a_n - \eg < L \land a_n \ge L) \\
			\iff &\big((\exists N \in \N .\, \forall n \ge N \co a_n \ge L) \land (\forall N \in \N .\, \exists n \ge N \co a_n \le L)\big)
		\end{align}
	\end{enumerate}
