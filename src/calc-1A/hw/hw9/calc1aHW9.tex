...
\begin{document}
	...
	נמצא עבור אילו $\ag, \bg$ הפונקציה רציפה, גזירה, גזירה ברציפות, או גזירה פעמיים ב־$0$. \begin{proof}
		\begin{itemize}
			...
			נוכל להפעיל את אותם הנימוקים לרציפות שהראינו קודם לכן לדרישה שהמעריכים של $x$ יהיו לפחות $1$. נקבל $\bg - 1 \ge 1$ וכן $\bg - \ag -1 \ge 1$. סה''כ את שני התנאים האלו אפשר לשלב ולדרוש $\bg \ge \ag + 2$ (לכל $\bg, \ag \in \N_+$). 
			\item \textbf{גזירה פעמיים: }נשאף לגזור את הפונקציה שקיבלנו לעיל. באמצעות נימוקים דומים לאילו שהפעלנו על גזירות תנאי הכרחי ומספיק יהיה שהמעריך של $x$ יהיה לכל הפחות $2$. כלומר, נדרוש $\bg - 1\ge 2$ וכן $\bg - \ag - 1 \ge 2$. נשלב את שני התנאים ונקבל $\bg \ge \ag  +3$ בהכרח. 
