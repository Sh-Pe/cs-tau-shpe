...
\begin{document}
	...
	נמצא עבור אילו $\ag, \bg$ הפונקציה רציפה, גזירה, גזירה ברציפות, או גזירה פעמיים ב־$0$. \begin{proof}
		\begin{itemize}
			...
			\item \textbf{גזירה פעמיים: }נשאף לגזור את הפונקציה הרציפה שקיבלנו לעיל. נדרוש $\bg > \ag + 1 \land \ag > 2$. זאת כי זה שקול לכך ש־$\bg - 1 \in \N_{\ge 2} \land \bg - \ag - 1 \in \N_{2}$, תנאי הכרחי ומספיק להיות הפונקציה לעיל גזירה ב־$0$ בעבור הוכחה דומה להוכחה הקודמת של גזירות. 
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			\item \textbf{צעד: }
			\[ \cl{x^{n + 1}\logx}^{(n + 1)} = \cl{(x^{n + 1}\log x)^{(n)}}' \]
			\[ \frac{n!}{x} \]
		\end{itemize}
	\end{proof}
