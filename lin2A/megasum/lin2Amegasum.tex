...
%	למה זה הגיוני? כי הסיבה שעשינו מלכתחילה רדוקציה ל־$T$ נילפוטנטית היא כי $T - \lg I$ היא $T$־אינוו' ונילפוטנטית, ועתה רק נותר להוסיף את ה־$\lg I$ חזרה לקבלת המקרה הכללי. 
	...
	\end{enumerate}}
	\begin{proof}
		הגדרנו $\rk f$ כאשר $f$ בילינארית להיות הדרגה של המייצגת את התבנית, וראינו שהיא לא תלויה בבסיס. בכך למעשה כבר הוכחנו את \textit{1.}. עבור \textit{2.}, מתקיים $A' = P^TAP$ ו־$P$ הפיכה (ולמעשה מטריצת מעבר בסיס) ולכן אם נסמן $c = |P| = |P^T|$ מתקיים: 
	...
	\theo{תהי $f$ תבנית בילינארית על $V$, ו־$B = (v_i)_{i = 1}^{n}$ בסיס ל־$B$. נניח $A =(a_{ij})^{n}_{i, j = 1}$ המייצגת את $f$ ביחס ל־$B$. אז $f$ סימ'/אסימ' אמ''מ $A$ סימ'/אסימ'. }
	...
	\defi{יהי $V$ מ''ו מעל $\R$ ו־$f$ תבנית בילינארית מעל $V$. נאמר ש־$f$ חיובית/אי־שלילית/שלילית/אי־חיובית אם $\forall 0 \neq v \in V $ מתקיים ש־$f(v, v) > 0$/$f(v, v) \ge 0$/$f(v, v) < 0$/$f(v, v)\le 0$}
	...
	\defi{יהי $V$ מ''ו, \textit{מכפלה פנימית} מעל $\R$ היא תבנית בילינארית סימטרית חיובית מעל $V$, ומסומנת $f(v, u) = \la v, u \ra$ (ויש ספרים שמסמנים $\la v \mid u \ra$, $\smut\co V \times V \to \R$. }
...
%		TODO: to make it clear
	...
	תזכורת: $A \in M_n(\C)$ נקראית סימטרית אמ''מ $A = A^T$ והרמיטית אם $A = A^*$, ונורמלית אמ''מ $AA^* = A^*A$. 
	...
	\begin{proof}
		ידוע עבור נורמלית: 
		\[ A = \pms{\pms{a_1 & b_1 \\ -b_1 & a_1} \\ & \ddots \\ &&\pms{a_m & b_m \\ -b_m & a_m} \\ &&& \lg_1 \\ &&&&\ddots \\ &&&&&\lg_k} \]
