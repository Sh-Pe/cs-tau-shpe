...
\begin{document}
	...
	\begin{enumerate}[(A)]
		...
		\textbf{תשובה: }ראשית כל, נתבונן ב־$52!$ הסידורים האפשריים של החפיסה כולה. עתה נתבונן בקבוצת המשלים – כמות האפשרויות לחפיסות בהן ישנם 4 אסים רצופים. סדרה שכזו יכולה להתחיל ולהגמר ב־$52 - 4$ מקומות שונים, ובכל אופציה, את $52 - 4 = 48$ הקלפים הנותרים, יהיו $48! $ אפשרויות לסדר. סה"כ מכלל הכפל $58 \cdot 48!$ אפשרויות בקבוצת המשלים. אזי: 
		\[ \ans = \bm{52 - 48 \cdot 48!} \]
		...
		\textbf{תשובה: }נגדיר $=a_i$ כמות האפשרויות לסידור בו $i$ רצפים של 4 תווים. מובן כי $0 \le i \le \frac{52}{4} = 13$ (לא ייתכנו רצפים בסדר גודל הארוך יותר מהחפיסה כולה). 
			...
			כדי למצוא את $a_i$, נבחר את הרצף הראשון מבין $13$ האפשרויות, ואז נמצא $48 \cdot 48!$ באופן דומה לסעיף הקודם. נמשיך הלאה: השני מבין $12$ האפשרויות שנותרו, ולכך יהיו $44 \cdot 44!$ אפשרויות. בכלליות:
			\[ a_i = \sum_{j = 1}^{i}(14 - i) \cdot (52 - 4i) \cdot (52 - 4i)! \]
			...
			\begin{align*}
				...
				&= 52! - \sum_{k = 1}^{n} (-1)^{k - 1}\bink (14 - k)(52 - 4i) \cdot (52 - 4i)!
			\end{align*}
	\end{enumerate}
	\section{}
	\section{}
