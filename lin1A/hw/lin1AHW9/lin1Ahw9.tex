...
\author{שחר פרץ}
\title{\textit{אלגברה ליניארית 1א $\sim$ תרגיל בית 9}}
\begin{document}
	\maketitle
	
	\section{}
	יהיו $A, B \in M_n(\F)$ מטריצות דומות. נוכיח שהמטריצות הבאות דומות: 
	\begin{enumerate}
		\item $A^{T} \sim B^{T}$
		\begin{proof}
			ידוע שבעבור $A, B$ קיים רצף פעולות אלמנטריות $E^A_1 \cdots E^A_m \in M_n(\F)$  ומטרציה מדורגת $\tl A \in M_n(\F)$־ כך שהמכפלה $B \cdot \prod E^A_i = A$. באופן דומה נגדיר $(E_i^B)$ רצף אלמנטריות ו־$\tl B$ מדורגת. בעבור $B$. 
		\end{proof}
	\end{enumerate}
